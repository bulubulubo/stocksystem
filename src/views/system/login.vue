...
import loginStocksJpg from '@/assets/login/stocks.jpg';
...
.container {
  ...
  width: 100vw;
  height: 100vh;
  background:  linear-gradient(rgba(73, 135, 141, 0.3), rgb(73, 126, 210))  no-repeat center;
  overflow: hidden;
  ...
  .box {
    ...
    .login-content-left {
      ...
      .login-content-left-mask {
        ...
        width: 100%;
        height: 100%;
        background-image: linear-gradient(rgba(73, 135, 141, 0.3), rgb(63, 51, 224));
        text-align: center;
        color: #fff;
        font-size: 1.8rem;
        display: flex;
